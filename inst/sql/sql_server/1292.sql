...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (19058410,739471,1343039,19089810,1366310,1351541,1344381,19010792,1356461,1315286,35807385,35807349,42900250,963987,1361291,40239056,1366773)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (19058410,739471,1343039,19089810,1366310,1351541,1344381,19010792,1356461,1315286,35807385,35807349,42900250,963987,1361291,40239056,1366773)
  and c.invalid_reason is null

) I
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1300978,1500211)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1300978,1500211)
  and c.invalid_reason is null
...
JOIN 
(
  select ENDS.person_id, min(drug_exposure_start_date) as era_start_date, DATEADD(day,210, ENDS.era_end_date) as era_end_date
  from
  (
